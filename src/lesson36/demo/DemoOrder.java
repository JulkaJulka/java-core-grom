...
public class DemoOrder {
    public static void main(String[] args) throws Exception {
       ...
       // Order order1 = new Order(user1,)
        ...
        Order order1 = new Order(user1, room1,date,date,3000d);

        OrderService orderService = new OrderService();
        orderService.cancelReservation(333l,1001l);
        //orderService.bookRoom(333l,1001l,333l);

        //OrderRepository orderRepository = new OrderRepository();
        //orderRepository.deleteEntity(3951493242468572042l);
      // orderRepository.bookRoom(333l,1001l,333l);
     //   orderRepository.cancelReservation(333l,1001l);
       // System.out.println(orderRepository.entityToArrayList().toString());
